...
<style type="text/css">
  ...
  <tr> 
    <td colspan="3"><h3>DAFTAR TANAMAN</h3></td>
  </tr>
  <tr class="fontc"> 
    <th width="80" class="fontc"><b>KODE</b></th>
    <th class="fontc"><b>NAMA TANAMAN</b></th>
    <th class="fontc"><b>KRITERIA</b></th>
  </tr>

  <?php 
    // Menampilkan daftar tanaman
  $sql = "SELECT * FROM tanaman ORDER BY kd_tanaman";
  ...
  <tr> 
    <td><?php echo $data['kd_tanaman']; ?></td>
    <td><?php echo $data['nm_tanaman']; ?></td>
    <td><a class="btn btn-success raised btn-xs" href="kriteria.php?kdtanaman=<?php echo $data['kd_tanaman']; ?>"><small>Lihat</small></a></td>
  </tr>
